...
import { Eye, EyeOff, CheckCircle, XCircle, KeyRound, LogIn } from 'lucide-react';
...
const PageSkeleton: React.FC = () => (
  <div style={{ minHeight: '100vh', background: '#f7f8fc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
    <div style={{ width: '100%', maxWidth: 460 }}>
      ...
      <div style={{ background: '#fff', borderRadius: 24, padding: '40px 36px', boxShadow: '0 4px 32px rgba(0,0,0,0.06)' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, marginBottom: 32 }}>
          ...
          <Bone w="160px" h={20} r={6} />
          <Bone w="220px" h={14} r={6} />
        </div>
...
const SubmitOverlay: React.FC = () => (
  ...
  >
    ...
    <div style={{ textAlign: 'center' }}>
      <p style={{ margin: 0, fontWeight: 800, fontSize: '1rem', color: '#1a1a1a' }}>Resetting your password…</p>
...
const ResetPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.response?.data?.message || 'This link is invalid or has expired. Please request a new reset.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#f7f8fc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        ...
        >
          ...
          <h2 style={{ fontWeight: 900, fontSize: '1.5rem', color: '#1a1a1a', margin: '0 0 10px' }}>Password reset!</h2>
          <p style={{ color: '#888', fontSize: '0.9rem', margin: '0 0 32px', lineHeight: 1.6 }}>
            Your password has been updated. You can now sign in to {storeName} with your new password.
          </p>
          <button
  ...
  return (
    <>
      <style>{`
        ...
        .rp-input:focus{border-color:var(--prime-orange)!important;background:#fff!important;box-shadow:0 0 0 3px rgba(255,140,66,0.1)!important}
      `}</style>
      ...
      <div style={{ minHeight: '100vh', background: '#f7f8fc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        ...
        >
          {/* Orange top bar */}
          <div style={{ height: 5, borderRadius: '3px 3px 0 0', background: 'linear-gradient(90deg,#ff6b35,#ff8c42)' }} />
          ...
          <div style={{ background: '#fff', borderRadius: '0 0 24px 24px', padding: '40px 36px 36px', boxShadow: '0 4px 32px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 6 }}>
                <KeyRound size={18} color="var(--prime-orange)" strokeWidth={2.5} />
                <h1 style={{ margin: 0, fontWeight: 900, fontSize: '1.25rem', color: '#1a1a1a' }}>Reset Your Password</h1>
              </div>
              <p style={{ margin: 0, fontSize: '0.85rem', color: '#aaa' }}>Create a new secure password for your {storeName} account</p>
            </div>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    style={{ ...inputBase, borderColor: confirm.length > 0 ? (confirmOk ? '#10b981' : '#ef4444') : '#e8e8e8' }}
                    autoComplete="new-password"
                  />
